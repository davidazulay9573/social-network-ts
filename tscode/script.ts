...
let buttonOfSendRegister = document.getElementById(
  "sendRegister"
...
let buttonOfSendLogin = document.getElementById(
  "sendLogin"
) as HTMLButtonElement;
...
System.allUsers.then((j: User) => console.log(j));
